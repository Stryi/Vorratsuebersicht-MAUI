...
private void ShowDatabaseInfoText()
        ...
        private void ShowDatabaseName()
        {
            ...
            if (databaseName == null)
            {
                this.ActionBar.Subtitle = "Keine Datenbank ausgewählt";
                return;
            }
            ...
            {
                this.ActionBar.Subtitle = String.Format(" {0}: {1}", this.Resources.GetString(Resource.String.Main_Database), dbFileName);
                return;
            }
        ...
        private void ButtonBarcode_Click(object sender, System.EventArgs e)
        {
            ...
            // TODO: StartActivityForResult(typeof(ZXingFragmentActivity), EANScanID);
        }
                ...
                selectDialog.SetItems(actions.ToArray(), (sender2, args) =>
                {
                    switch(args.Which)
                    {
                        ...
                        case 2:
                            ...
                            // TODO AddToShoppingListDialog.ShowDialog(this, articleId);
                            break;
                        case 3:
                            if (shoppingItemCount == 0)
                                shoppingItemCount = 1;
