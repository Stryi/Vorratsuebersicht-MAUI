...
namespace VorratsUebersicht
{
    ...
    public class ShoppingListActivity : Activity, SearchView.IOnQueryTextListener
    {
        ...
        public override bool OnCreateOptionsMenu(IMenu menu)
        {
            ...
            {
                case 1:
                    sortMenuItem.SetIcon(Resource.Mipmap.baseline_sort_CHECK_white_24);
                    break;

                case 2:
                    sortMenuItem.SetIcon(Resource.Mipmap.baseline_sort_SHOP_white_24);
                    break;

                case 3:
                    sortMenuItem.SetIcon(Resource.Mipmap.baseline_sort_TIME_white_24);
                    break;
